...
CREATE TABLE `seguidores` (
  ...
  CONSTRAINT `seguidores_ibfk_1` FOREIGN KEY (`id_usuario_seguidor`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `seguidores_ibfk_2` FOREIGN KEY (`id_usuario_seguido`) REFERENCES `usuarios` (`id`)
...
INSERT INTO `seguidores` VALUES (1,1,1),(2,2,2),(3,2,2);
